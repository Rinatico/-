...
|3 | Если текущее время превышает время окончания маршрута, то временной интервал маршрута обновляется | FAILED | https://rinat223.youtrack.cloud/issue/1E-58/Pri-proverki-na-smartfone-obnaruzhilas-bag-svyazanno-s-obnovlenie-vremennogo-intervala| 1.2
| |	**Способы выбора станции:**| | |2.1|
|4 | Тапом на схеме | PASSED		
|5 | По иконке i из разных карточек | PASSED	
|6 | Если из поиска выбрать станцию тапом на i и закрыть карточку, должен происходить возврат на экран поиска | FAILED | (https://rinat223.youtrack.cloud/issue/1E-59/Pri-proverki-na-smartfone-obnaruzhilas-bag-svyazanno-s-tapom-v-pole-Otkuda)
...
|10 | Выбранная станция сохраняется в истории: при нажатии на поле Откуда или Куда раскрывается список, содержащий станции, которые пользователь выбирал ранее | FAILED | https://rinat223.youtrack.cloud/issue/1E-62/Pri-proverki-na-smartfone-obnaruzhilas-bag-rannyaya-vybrana-stancii-ne-sohranyaetsya
...
|15 | При смене ориентации с портретной на ландшафтную детали маршрута в карточке отображаются в левой части экрана | PASSED |  3.2
| |	**Уведомление об ошибке:**| | |4 |	
|16 | При отсутствии интернет-соединения появляется уведомление об ошибке | PASSED | 
| |	**Альбомная ориентация:**| | |5|
|17 | Все карточки и поля поиска отображаются в левой части экрана | PASSED		
|18 | При смене ориентации экрана масштаб построенного маршрута не должен увеличиться или уменьшиться | FAILED |(https://rinat223.youtrack.cloud/issue/1E-63/Pri-proverki-na-smartfone-obnaruzhilas-bag-rannyaya-vybrana-stancii-ne-sohranyaetsyaposle-obnovlenie-prilozhenie)
| | **Лонг-тап по станции:**| | | 6|
|19 | При нажатии на станцию при помощи лонг-тапа открывается карточка станции с кнопками «Отсюда»/«Сюда» | FAILED | (https://rinat223.youtrack.cloud/issue/1E-75/Pri-proverki-na-smartfone-obnaruzhilsya-bag-ne-polnostyu-otkryta-kartochka-stanciya)
|20 | Схема не должна смещаться вверх/вниз/влево/вправо при лонгтапе по станции | FAILED | https://rinat223.youtrack.cloud/issue/1E-74/Pri-proverki-na-smartfone-obnaruzhilsya-bag-pri-longtape-po-stancii-shema-smeshaetsya	
...
|23 | Пин на станции и выделение станции пропадает, когда она не попадает в зону клика | FAILED |https://rinat223.youtrack.cloud/issue/1E-67/Pri-proverki-na-smartfone-obnaruzhilsya-bag-pri-vybrannom-stancii
