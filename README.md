...
|23|	Всплывающее окно "Добавить карту в нем  есть плейсколдеры шрифт серый не выходят за границы поля
 ввода плейсхолдеры выглодат одинаково одинако отступы по сторонам нет орфографических ошибок|PASSED|	PASSED|	-|
